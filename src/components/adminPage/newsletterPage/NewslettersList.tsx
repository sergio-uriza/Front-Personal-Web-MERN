...
export const NewslettersList = memo(function NewslettersList ({
  page,
  handleTotalPages,
  order,
  newGet,
  ...
  const { newslettersList } = useGetMultipleNewsletter(25, page, handleTotalPages, order, newGet)
