...
export function NewsletterItem ({ newsletter, handleNewGet }: PropsType): JSX.Element {
  ...
  const handleOpenConfirmModalDelete = (): void => {
    setModalConfirmMessage('Do you really want to remove the email contact from this subscriber? Remember that this action has no way to be reversed.')
    ...
    <Grid xs={12} sm={12} md={12} lg={6}>
      ...
      >
        ...
        <ConfirmModal
          ...
          ModalTitle={`Delete to ${newsletter.email}`}
