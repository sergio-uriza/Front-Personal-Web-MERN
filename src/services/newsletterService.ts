...
import { GetMultipleNewsletterType, MessageResponseType } from './types'

export const getMultipleNewsletter = async (accessToken: string | null, limit = 10, page = 1, order = 1): Promise<GetMultipleNewsletterType> => {
...
export const deleteNewsletter = async (accessToken: string | null, idNewsletter: string): Promise<MessageResponseType> => {
  if (accessToken == null) throw new Error('Request Error, you do not have credentials')
